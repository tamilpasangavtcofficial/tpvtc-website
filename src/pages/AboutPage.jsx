  ...
  return (
    <div className="container py-5">
      ...
      <div className="text-center reveal mb-5">
        <img src={logo} alt="Tamil Pasanga VTC Logo" className="mb-4 shadow-lg rounded-3" style={{ height: '90px', objectFit: 'contain' }} />
        <h1 className="display-5 fw-bold mb-3 text-white">About Tamil Pasanga VTC</h1>
      ...
      <section className="mb-5 reveal delay-1">
        <div className="row g-3">
          <div className="col-md-6">
            <div className="card-banner rounded-4 overflow-hidden h-100 shadow-lg" style={{ minHeight: '300px' }}>
              <img src={img1} alt="Gallery 1" className="w-100 h-100 object-fit-cover transition-all" style={{ transition: 'transform 0.4s ease' }} onMouseOver={e=>e.currentTarget.style.transform='scale(1.03)'} onMouseOut={e=>e.currentTarget.style.transform='scale(1)'}/>
            </div>
          </div>
          <div className="col-md-6">
      ...
      <section className="row g-4 mb-5">
        <div className="col-lg-6">
          <div className="content-card reveal h-100 text-start">
            <div className="d-flex align-items-center mb-4">
              <span className="badge bg-white text-black fw-bold rounded-pill px-3 py-1 me-3 small" style={{ letterSpacing: '0.5px' }}>VISION</span>
        ...
        <div className="col-lg-6">
          <div className="content-card reveal delay-1 h-100 text-start">
            <div className="d-flex align-items-center mb-4">
               <span className="badge bg-white text-black fw-bold rounded-pill px-3 py-1 me-3 small" style={{ letterSpacing: '0.5px' }}>TARGET</span>
            ...
            <div className="d-flex flex-wrap gap-2 mt-auto">
              <span className="badge rounded-pill border border-white border-opacity-20 text-white px-3 py-2 fw-medium">🚚 Realistic Driving</span>
              <span className="badge rounded-pill border border-white border-opacity-20 text-white px-3 py-2 fw-medium">🤝 Family Environment</span>
              <span className="badge rounded-pill border border-white border-opacity-20 text-white px-3 py-2 fw-medium">🌍 Unity & Respect</span>
              <span className="badge rounded-pill bg-white text-black px-3 py-2 fw-bold shadow-lg">🚛 Grow Together</span>
            </div>
            </div>
          </div>
        </div>
